...
public class MainLaura {
	...
	public static void main(String[] args) {
		 ...
		 * en una lista y muestra los datos de los veterinarios. 15. Genera un resumen
		 ...
		 * factura con la fecha actual y muestra la nueva factura generada 17. Elimina
		 * un tratamiento del historial y rehaz una factura. Selecciona una mascota,
